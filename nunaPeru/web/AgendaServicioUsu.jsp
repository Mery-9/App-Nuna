...
<div class="sidebar-wrapper" style="background: #13a4d4;">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="AgendacCitaUsu.jsp?cod=<%= rs.getString("id_cliente")%>">
                      ...
                      <li >
                        <a class="nav-link" href="MovilidadUsu.jsp?cod=<%= rs.getString("id_cliente")%>">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo"><i class="nc-icon nc-notes"></i> Servicios Reservados </a>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row" style="width: 70%; text-align: center;">
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Servicios reservados</h4>
                                </div>
                     ...
                     <%ps=con.prepareStatement("select * from mascota where id_cliente='"+cod+"'");
                           rs=ps.executeQuery();
                               while(rs.next()){%>  
                                        <tbody>
                                            <td><img src="CargarIMGMascota?id=<%= rs.getString("id_mascota")%>" width="100" height="100"></td>
                                                <td><%= rs.getString("nom_mascota")%></td>
                                                <td><%= rs.getString("tipo_mascota")%></td>
                                                <td><%= rs.getString("raza_mascota")%></td>

                                                <td><a href="ServicioPorMascota.jsp?cod=<%=cod%>&idmasc=<%= rs.getString("id_mascota")%>" type="submit" class="btn btn-default" style="color: white; text-decoration: none; float: right; border-color:#13a4d4; border-radius: 15px; border: 4px solid #0016b0; background: #13a4d4;">Visualizar</a></td>
                                            </tr>
                                            <%}%>
                                        </tbody> 
                                    </table>
